...
```{r read,include=TRUE,message=FALSE,warning=FALSE}
...
## Adjacency Matrix 
```{r transform,include=TRUE,message=FALSE,warning=FALSE}
...
```{r attributes,include=TRUE,message=FALSE,warning=FALSE}
...
```{r centrality,include=TRUE,message=FALSE,warning=FALSE}
...
```{r isolates,include=TRUE,message=FALSE,warning=FALSE}
...
```{r community,include=TRUE,message=FALSE,warning=FALSE}
...
```{r d3,include=TRUE,message=FALSE,warning=FALSE}
library(networkD3)
